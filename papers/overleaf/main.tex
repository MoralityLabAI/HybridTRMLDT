...
\begin{enumerate}
  ...
  \item Induce AIRIS rules from calibration transitions rather than exporting topology plans, then evaluate
  intact-but-wrong rules, accepted-proposal utility, and fallback coverage on held-out contexts.
