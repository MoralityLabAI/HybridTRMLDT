...
The ablation strengthens the paper's membrane claim. Token-derived LDT candidate sets are useful as soft telemetry, but hard-eliminating TRM routes from this evidence is unsafe. Soft hybrid preserves TRM's `0.815` accuracy; hard filtering drops to `0.584`.
